...
glob.glob("../fb_scrapper/data/{}/*_page.csv".format(TOPIC) )
...
page_ids = []
for a_path in glob.glob("../fb_scrapper/data/{}/*_page.csv".format(TOPIC)):
...
with open(out_name, 'w') as out_file:
    for page_id in page_ids:
        csv_name          = '../fb_scrapper/data/{}/{}_page.csv'.format(TOPIC,page_id)
        csv_comments_name = '../fb_scrapper/data/{}/{}_page_comments.csv'.format(TOPIC,page_id)
